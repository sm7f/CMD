...
Argumento final: (Motivo de alguma prioridade ou urgência)
 
Anexos: (Cópia do banco de dados, prints/vídeos)
 
---------------------------------------------------------------

Criação de ticket (.Net)
 
CNPJ - 46.343.418/0001-00

Cliente -  INFANTE CHIC
...
Anexos: (Vídeo/fotos, foto das configurações da maquina MENU-> AJUSTES-> SOBRE(STONE), StoneCODE).
